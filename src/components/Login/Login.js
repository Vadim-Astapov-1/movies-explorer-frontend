...
function Login({ onLogin, reqError }) {
  ...
  return (
    ...
    >
      <label className='auth__title-input' htmlFor='login-email-input'>
        E-mail
      </label>
      <input
        type='email'
        ...
        required
      ></input>
      <span className='auth__input-error' id='login-email-input-error'>
        {validation.errors.email}
      </span>
      <label className='auth__title-input' htmlFor='login-password-input'>
        Пароль
      </label>
      <input
        type='password'
        ...
        required
      ></input>
      <span className='auth__input-error' id='login-password-input-error'>
