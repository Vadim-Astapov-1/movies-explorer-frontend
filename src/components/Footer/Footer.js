    ...
    checkRouter(footerRouters) && (
      ...
      <div className='footer__container'>
        ...
        <nav className='footer__nav'>
          ...
          <a href='https://github.com/Vadim-Astapov-1?tab=repositories' className='footer__link' target='_blank'>Github</a>
          <a href='https://www.facebook.com/profile.php?id=100021774372638' className='footer__link' target='_blank'>Facebook</a>
        </nav>
      </div>
    </footer>
    )
